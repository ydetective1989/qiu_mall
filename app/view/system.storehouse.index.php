...
<table width="100%" height="100%" >
  <tr>
    <td height="40" class="bold">&nbsp;仓库管理</td>
    <td align="right">
	      <span><input type="button" value="增加仓库" class="button" onclick="frminfo.location.href='<?php echo $S_ROOT;?>system/storehouse?show=add'" />&nbsp;&nbsp;</span>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <iframe src="<?php echo $S_ROOT;?>system/storehouse?show=lists" width="100%" height="100%" name="frminfo" scrolling="auto" noresize="noresize" id="frminfo" frameborder="no" style="" /></iframe>
    </td>
  </tr>
</table>
</body>
...
<div class="forms">
  ...
  <table width="100%" class="tdcenter">
  	<tr class="bgheader white">
  		<td width="100" class="" height="30">仓库名称</td>
  		<td width="100" class="">仓库编码</td>
  	...
  	<tr class="datas">
  		...
  		<td class="gray"><a href="<?php echo $S_ROOT;?>system/storehouse?show=edit&id=<?php echo $rs["id"];?>">[修改]</a></td>
  	</tr>
  	<?php }?>
    	<tr>
