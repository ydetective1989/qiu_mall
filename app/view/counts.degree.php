...
<script type="text/javascript" src="<?php echo $S_ROOT;?>js/counts.degree.js?<?php echo date("Ymd");?>"></script>
</head>
<body scroll="no">
...
<table width="100%">
  <tr class="bgheader">
    <td colspan="5" height="30" class="tdcenter bold">付款状态</td>
  </tr>
  <tr class="bgtips">
    <td width="20%" height="30">回访次数</td>
    <td width="20%">销售记录数</td>
    <td width="20%">销售得分</td>
    <td width="20%">服务记录数</td>
    <td width="20%">服务得分</td>
  </tr>
  <tr>
    <td height="30"><?php echo (int)$allnums;?></td>
    <td><?php echo (int)$salenums;?></td>
    <td><?php echo $saledegree;?></td>
    <td><?php echo (int)$afternums;?></td>
    <td><?php echo $afterdegree;?></td>
  </tr>
</table>
...
<table width="100%">
  <tr class="bgheader">
    <td colspan="4" height="30" class="tdcenter bold">销售得分一览</td>
  </tr>
  <tr class="bgtips">
    <td width="30%" height="30">销售人员姓名</td>
    <td width="35%" >记录数</td>
    <td width="35%" >满意度</td>
  </tr>
  <?php foreach($salescount AS $rs){?>
  <tr>
    <td height="30"><?php echo $rs["worknum"]?>_<?php echo $rs["name"]?></td>
    <td><?php echo (int)$rs["nums"]?></td>
...
<table width="100%">
  <tr class="bgheader">
    <td colspan="4" height="30" class="tdcenter bold">服务得分一览</td>
  </tr>
  <tr class="bgtips">
    <td width="30%" height="30">服务人员姓名</td>
    <td width="35%" >记录数</td>
    <td width="35%" >满意度</td>
  </tr>
  <?php foreach($aftercount AS $rs){?>
  <tr>
    <td height="30"><?php echo $rs["worknum"]?>_<?php echo $rs["name"]?></td>
    <td><?php echo (int)$rs["nums"]?></td>
    <td><?php echo $rs["degree"];?></td>
