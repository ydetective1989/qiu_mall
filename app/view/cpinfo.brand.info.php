...
<table width="100%">
  <tr>
    <td height="30" class="bgfocus tdcenter white"><?php echo ($_GET["do"]=="add")?"增加":"修改"; ?>品牌信息</td>
  </tr>
</table>
...
<table width="100%" class="table">
  ...
  <tr>
    <td width="30%" class="tdright">品牌名称：</td>
  ...
  <tr>
    <td class=""></td>
    <td class=""><input type="button" class="button" id="editbtn" onclick="editbrand()" value="<?php echo ($_GET["show"]=="add")?"增加":"修改"; ?>品牌信息">
