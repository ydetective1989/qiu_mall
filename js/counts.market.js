...
function countsd()
{
	...
	var salesarea	= $("#salesarea").val();
	var salesid		= $("#salesid").val();
	frminfo.location.href = S_ROOT+"counts/market?show=1&godate="+godate+"&todate="+todate+"&salesarea="+salesarea+"&salesid="+salesid;
}
...
function views(id)
{
	$.ajax({  
	    type: "GET",  
		async: false,
	    url: S_ROOT+"counts/market?show=2&id="+id,
	    data: "",             
