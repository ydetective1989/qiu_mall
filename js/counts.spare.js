$(function() {
	var dates = $("#godate,#todate").datepicker({
		...
		onSelect: function( selectedDate ) {
			...
			$("#userid").load(S_ROOT+"counts/tags?show=users&godate="+godate+"&todate="+todate+"&"+ Math.random());
...
function countsd()
{
	...
	$("#frminfo").contents().find('#showed').load(S_ROOT+"counts/spare?show=info&godate="+godate+"&todate="+todate+"&afterarea="+afterarea+"&afterid="+afterid);
