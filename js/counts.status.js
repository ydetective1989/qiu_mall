...
function countsd()
{
	...
	$("#frminfo").contents().find('#showed').load(S_ROOT+"counts/ostatus?show=1&godate="+godate+"&todate="+todate+"&salesarea="+salesarea+"&salesid="+salesid+"&saleuserid="+saleuserid);
}
...
function xlsed()
{
	...
	frminfo.location.href = S_ROOT + "xls/status?show=xls&" + urlto;
