...
function countsd()
{
	...
	$("#frminfo").contents().find('#showed').load(S_ROOT+"counts/product?show=1&godate="+godate+"&todate="+todate+"&provid="+provid+"&cityid="+cityid+"&areaid="+areaid+"&salesarea="+salesarea+"&salesid="+salesid+"&saleuserid="+saleuserid);
}
