...
**************************/
        var strHtml1="<br><font color='#FF00FF'>打印控件未安装!点击这里(<a href='"+S_ROOT+"upfile/install_lodop.exe
'>32位系统</a>)(<a href='"+S_ROOT+"upfile/install_lodop64.exe
'>64位系统</a>),下载后进行安装，完成后刷新页面或重新进入。</font>";
        var strHtml2="<br><font color='#FF00FF'>打印控件需要升级!点击这里(<a href='"+S_ROOT+"upfile/install_lodop.exe
'>32位系统</a>)(<a href='"+S_ROOT+"upfile/install_lodop64.exe
'>64位系统</a>),升级后请重新进入。</font>";
