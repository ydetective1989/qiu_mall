...
function countsd()
{
	...
	$("#frminfo").contents().find('#showed').load(S_ROOT+"counts/degreelogs?show=1&godate="+godate+"&todate="+todate+"&salesarea="+salesarea+"&salesid="+salesid+"&afterarea="+afterarea+"&afterid="+afterid);
...
function xlsed()
{
	...
	var afterarea	= $("#afterarea").val();
	var afterid	= $("#afterid").val();
	var urlto = "godate="+godate+"&todate="+todate+"&salesarea="+salesarea+"&salesid="+salesid+"&afterarea="+afterarea+"&afterid="+afterid;
	frminfo.location.href = S_ROOT + "xls/degreelogs?show=xls&" + urlto;
}
